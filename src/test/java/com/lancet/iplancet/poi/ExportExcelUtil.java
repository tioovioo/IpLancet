...
public class ExportExcelUtil<T>{
    ...
    public void exportExcel(String title, Collection<T> dataset, OutputStream out, String version) {
        if(StringUtil.isEmpty(version) || EXCEL_FILE_2003.equals(version.trim())){
     ...
     * @param version 2003 或者 2007，不传时默认生成2003版本
     */
    public void HTTPExportFile(String fileName, String title, String[] headers, Collection<T> dataset, HttpServletResponse response, String version) {
        try {
